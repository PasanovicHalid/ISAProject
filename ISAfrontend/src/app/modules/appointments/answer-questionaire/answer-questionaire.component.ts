...
@Component({
  selector: 'app-answer-questionaire',
  templateUrl: './answer-questionaire.component.html',
  styleUrls: ['./answer-questionaire.component.css']
})
export class AnswerQuestionaireComponent implements OnInit {
